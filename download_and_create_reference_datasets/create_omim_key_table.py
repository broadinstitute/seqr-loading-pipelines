...
run("python gcloud_dataproc/run_script.py --cluster omim hail_scripts/convert_tsv_to_key_table.py --key-by 'Ensembl Gene ID' {GCLOUD_BUCKET_PATH}/{filename}".format(**locals()))

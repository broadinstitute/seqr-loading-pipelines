import hail as hl
from hail import Locus

# Sample variant annotated with VEP.
VEP_DATA = {
    'rs35471880': {
        'vep': hl.struct(**{'allele_string': 'G/A',
...
DERIVED_DATA = {
    'rs35471880': {'AC': 5,
                   ...
                   'contig': '1',
                   'docId': '1-881918-G-A',
                   'domains': {'Pfam_domain:PF03715',
                               'Superfamily_domains:SSF48371',
                               'hmmpanther:PTHR12687'},
                   'end': 881919,
                   'filters': set(),
                   'geneIds': {'ENSG00000188976'},
                   'locus': Locus(contig=1, position=881918, reference_genome='GRCh37'),
                   'mainTranscript': {'amino_acids': 'S/L',
                                      'biotype': 'protein_coding',
                                      'canonical': 1,
                                      'category': 'missense',
                                      'cdna_end': 1717,
                   ...
                   'ref': 'G',
                   'rsid': 'rs35471880',
                   'sortedTranscriptConsequences': [{'amino_acids': 'S/L',
                                                     'biotype': 'protein_coding',
                                                     'canonical': 1,
                                                     'category': 'missense',
                                                     'cdna_end': 1717,
                                                    ...
                                                    {'amino_acids': None,
                                                     ...
                                                     'transcript_rank': 2}],
                   'start': 881918,
                   'transcriptConsequenceTerms': {'missense_variant',

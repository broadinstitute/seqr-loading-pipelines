...
from luigi_pipeline.seqr_loading import SeqrVCFToMTTask, SeqrValidationError
...
class TestSeqrLoadingTasks(unittest.TestCase):
    ...
    def test_seqr_loading_validate_match_none(self, mock_sample_type_stats, mock_contig_check):
        ...
        self.assertRaises(SeqrValidationError, SeqrVCFToMTTask.validate_mt, self.test_mt, '37', None)
    ...
    @patch('lib.hail_tasks.HailMatrixTableTask.sample_type_stats')
    def test_seqr_loading_validate_match_coding_only(self, mock_sample_type_stats, mock_contig_check):
    ...
    @patch('lib.hail_tasks.HailMatrixTableTask.sample_type_stats')
    def test_seqr_loading_validate_match_noncoding_only(self, mock_sample_type_stats, mock_contig_check):

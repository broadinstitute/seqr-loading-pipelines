...
EXPECTED_DATA_GENOTYPES = [
    hl.Struct(
        **EXPECTED_DATA_VARIANTS[0],
        ...
        genotypes=[hl.Struct(sample_id='SAMPLE-1', gq=59, cn=None, num_alt=2, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-2', gq=26, cn=None, num_alt=2, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-3', gq=39, cn=None, num_alt=2, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-4', gq=19, cn=None, num_alt=1, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-5', gq=19, cn=None, num_alt=1, new_call=True, prev_num_alt=None)],
    ...
    hl.Struct(
        **EXPECTED_DATA_VARIANTS[1],
        samples_no_call=set(),
        samples_new_call={'SAMPLE-1', 'SAMPLE-2', 'SAMPLE-3', 'SAMPLE-4', 'SAMPLE-5'},
        genotypes=[hl.Struct(sample_id='SAMPLE-1', gq=62, cn=None, num_alt=1, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-2', gq=99, cn=None, num_alt=0, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-3', gq=99, cn=None, num_alt=0, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-4', gq=99, cn=None, num_alt=0, new_call=True, prev_num_alt=None),
                   hl.Struct(sample_id='SAMPLE-5', gq=99, cn=None, num_alt=0, new_call=True, prev_num_alt=None)],

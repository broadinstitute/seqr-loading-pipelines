...
VCF_DATA_ROW = [
    ...
    [
        ...
        'GT:EV:GQ:PE_GQ:PE_GT:SR_GQ:SR_GT:RD_CN',
        '0/0:PE,SR:99:99:0:99:0:2',
        '0/1:PE,SR:57:0:0:57:1:2',
        '0/1:PE,SR:0:0:1:99:0:2',
        '0/0:PE,SR:99:99:0:0:0:3',
    ...
    [
        ...
        '526',
        'HIGH_SR_BACKGROUND',
        'ALGORITHMS=melt;CHR2=chr1;END=48963135;EVIDENCE=SR;PREDICTED_INTRONIC=AGBL4;PREDICTED_NONCODING_BREAKPOINT=Tommerup_TADanno;SVLEN=5520;SVTYPE=INS;AN=8;AC=1;AF=0.06338;N_BI_GENOS=2911;N_HOMREF=2544;N_HET=365;N_HOMALT=2;FREQ_HOMREF=0.873926;FREQ_HET=0.125386;FREQ_HOMALT=0.000687049;MALE_AN=2894;MALE_AC=177;MALE_AF=0.061161;MALE_N_BI_GENOS=1447;MALE_N_HOMREF=1271;MALE_N_HET=175;MALE_N_HOMALT=1;MALE_FREQ_HOMREF=0.878369;MALE_FREQ_HET=0.12094;MALE_FREQ_HOMALT=0.000691085;FEMALE_AN=2906;FEMALE_AC=192;FEMALE_AF=0.06607;FEMALE_N_BI_GENOS=1453;FEMALE_N_HOMREF=1262;FEMALE_N_HET=190;FEMALE_N_HOMALT=1;FEMALE_FREQ_HOMREF=0.868548;FEMALE_FREQ_HET=0.130764;FEMALE_FREQ_HOMALT=0.000688231',
        'GT:EV:GQ:PE_GQ:PE_GT:SR_GQ:SR_GT',
        '0/0:PE,SR:99:99:0:99:0',
        '0/0:PE,SR:99:99:0:99:0',
        '0/0:PE,SR:99:99:0:99:0',
    ...
    [
        ...
        'GT:EV:GQ:PE_GQ:PE_GT:SR_GQ:SR_GT',
        '0/0:PE,SR:99:99:0:99:0',
        '0/1:PE,SR:41:26:1:41:1',
        '1/1:PE,SR:89:33:1:89:2',
        '0/0:PE,SR:99:99:0:99:0',
        '0/0:PE,SR:99:99:0:99:0',
    ],
]
...
EXPECTED_DATA_VARIANTS = [
    hl.Struct(
        ...
        rg37_locus_end=hl.Locus(contig=1, position=724861, reference_genome='GRCh37'),
        svType='BND',
        transcriptConsequenceTerms={'NEAREST_TSS', 'BND'},
        sv_type_detail=None,
        geneIds=set(),
    ...
    hl.Struct(
        ...
        sv_callset_Het=590,
        sv_callset_Hom=3,
        gnomad_svs_ID='gnomAD-SV_v2.1_INS_chr1_65',
        gnomad_svs_AF=0.068962998688221,
        gnomad_svs_AC=224,
        gnomad_svs_AN=3247,
        pos=4228405,
        ...
        rg37_locus_end=hl.Locus(contig=1, position=4288508, reference_genome='GRCh37'),
        svType='INS',
        transcriptConsequenceTerms={'NEAREST_TSS', 'INS'},
        sv_type_detail='ME:ALU',
        geneIds=set(),
    ...
    hl.Struct(
        ...
        rg37_locus_end=hl.Locus(contig=1, position=6619783, reference_genome='GRCh37'),
        svType='CPX',
        transcriptConsequenceTerms={'INTRONIC', 'CPX'},
        sv_type_detail='INVdup',
...
EXPECTED_DATA_GENOTYPES = [
    hl.Struct(
        **EXPECTED_DATA_VARIANTS[0],
        samples_no_call=set(),
        genotypes=[
            hl.Struct(sample_id='SAMPLE-1', gq=59, cn=None, num_alt=2),
    ...
    hl.Struct(
        **EXPECTED_DATA_VARIANTS[1],
        samples_no_call=set(),
        genotypes=[
            hl.Struct(sample_id='SAMPLE-1', gq=62, cn=None, num_alt=1),
    ...
    hl.Struct(
        **EXPECTED_DATA_VARIANTS[2],
        samples_no_call=set(),
        genotypes=[
            hl.Struct(sample_id='SAMPLE-1', gq=99, cn=2, num_alt=0),

...
"""
This is a port from the v01 load_dataset.py so we can get the main functionality progress
and while we evaluate whether it's worth it to rewrite.
Most of this is the same, except for snippets with functions or comments named with `v02`.
"""
...
# V02 change. Unfortunately we need the current directory since it's changed all over the place :(

...
CLUSTER=dataproc-cluster-grch37
...
gcloud dataproc clusters create $CLUSTER   \
    ...
    --initialization-actions gs://hail-common/hail-init.sh,gs://hail-common/vep/vep/GRCh37/vep85-GRCh37-init.sh,gs://hail-common/init_notebook.py
    #--project exac-gnomad \

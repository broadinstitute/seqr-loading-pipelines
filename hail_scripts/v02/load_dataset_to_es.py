...
"""
Port from v01/load_dataset_to_es.py so all subsequent changes can be seen as diff
against v01.

TODO:
1. do minimal set of changes for v01 to v02, step by step
2. remove v01 references
"""

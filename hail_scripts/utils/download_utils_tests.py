...
class DownloadUtilsTest(unittest.TestCase):
    ...
    def test_download_file(self, mock_get_bucket, mock_gettempdir, mock_open, mock_getsize, mock_isfile,
        ...
        mock_logger.info.assert_called_with(f'Re-using default_test/dir/test_file.gz previously downloaded from {GZ_DATA_URL}')
        ...
        mock_bucket.blob.return_value.upload_from_filename.assert_called_with('test/dir/test_file.gz')

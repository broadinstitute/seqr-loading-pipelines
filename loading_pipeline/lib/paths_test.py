...
def test_project_table_path() -> None:
    assert (
        project_table_path(
...
def test_sex_check_table_path() -> None:
    assert (
        sex_check_table_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_relatedness_check_table_path() -> None:
    assert (
        relatedness_check_table_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_validation_errors_for_run_path() -> None:
    assert (
        validation_errors_for_run_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_metadata_for_run_path() -> None:
    assert (
        metadata_for_run_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_variant_annotations_table_path() -> None:
    assert (
        variant_annotations_table_path(
            ReferenceGenome.GRCh38,
            DatasetType.GCNV,
...
def test_remapped_and_subsetted_callset_path() -> None:
    assert (
        remapped_and_subsetted_callset_path(
            ReferenceGenome.GRCh38,
            DatasetType.GCNV,
...
def test_imported_callset_path() -> None:
    assert (
        imported_callset_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_tdr_metrics_path() -> None:
    assert (
        tdr_metrics_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_new_variants_table_path() -> None:
    assert (
        new_variants_table_path(
            ReferenceGenome.GRCh38,
            DatasetType.SNV_INDEL,
...
def test_project_pedigree_path() -> None:
    assert (
        project_pedigree_path(
            ReferenceGenome.GRCh38,
            DatasetType.GCNV,

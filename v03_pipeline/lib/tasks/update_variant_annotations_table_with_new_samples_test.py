        ...
        self.assertCountEqual(
            ...
            [
                hl.Struct(
                    ...
                    updates={
                        hl.Struct(
                            callset='v03_pipeline/var/test/callsets/ont_snv_indel_1.vcf',
                            project_guid='R0113_test_project',
                        ),
                    },
                ),
        ...
        self.assertCountEqual(
            ...
            [
                hl.Struct(
                    ...
                    variant_id='1-10004-C-G',
                    xpos=1000010004,
                    cadd=None,
                    clinvar=None,
                    hgmd=None,
                    gt_stats=hl.Struct(AC=0, AN=2, AF=0.0, hom=0),
                ),
                hl.Struct(
                    locus=hl.Locus(
                        contig='chr1',
                    ...
                    variant_id='1-10010-C-A',
                    xpos=1000010010,
                    cadd=None,
                    clinvar=None,
                    hgmd=None,
                    gt_stats=hl.Struct(AC=0, AN=4, AF=0.0, hom=0),
                ),
                hl.Struct(
                    locus=hl.Locus(
                        contig='chr1',
                ...
                hl.Struct(
                    ...
                    variant_id='1-10019-T-G',
                    xpos=1000010019,
                    cadd=None,
                    clinvar=None,
                    hgmd=None,
                    gt_stats=hl.Struct(AC=0, AN=0, AF=0.0, hom=0),
                ),
                hl.Struct(
                    locus=hl.Locus(
                        contig='chr1',

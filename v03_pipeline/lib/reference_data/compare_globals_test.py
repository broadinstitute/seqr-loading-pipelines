...
class CompareGlobalsTest(unittest.TestCase):
    ...
    def test_ht_version_matches_config_joined_ht_version_missing(self):
        ...
        result = ht_version_matches_config(
            joined_ht.index_globals(),
            'b',
            {},
            reference_genome=ReferenceGenome.GRCh38,
        )
        self.assertFalse(hl.eval(result))
    ...
    def test_ht_version_matches_config(self, mock_read_table):
        ...
        self.assertTrue(hl.eval(result))
    ...
    def test_ht_path_matches_config_joined_ht_path_missing(self):
        ...
        result = ht_path_matches_config(joined_ht.index_globals(), 'b', {})
        self.assertFalse(hl.eval(result))
    ...
    def test_ht_path_matches_config_no_match(self):
        ...
        self.assertFalse(hl.eval(result_a))
    ...
    def test_ht_path_matches_config_custom_import(self):
        ...
        self.assertTrue(hl.eval(result_b))
    ...
    def test_ht_enums_match_config_both_missing(self):
        ...
        result = ht_enums_match_config(joined_ht.index_globals(), 'b', {})
        self.assertTrue(hl.eval(result))
    ...
    def test_ht_enums_match_config_joined_ht_missing(self):
        ...
        result = ht_enums_match_config(joined_ht.index_globals(), 'b', dataset_config)
        self.assertFalse(hl.eval(result))
    ...
    def test_ht_enums_match_config(self):
        ...
        result = ht_enums_match_config(joined_ht.index_globals(), 'a', dataset_config)
        self.assertTrue(hl.eval(result))

    def test_ht_enums_match_config_no_match(self):
    ...
    def test_ht_selects_match_config_no_match(self):

    ...
    def test_table_name_builder(self):
        ...
        with patch('v03_pipeline.lib.paths.Env') as mock_env:
            ...
            self.assertEqual(
                ...
                "gcs(hail_search_data_dir_named_collection, url='https://storage.googleapis.com/mock_bucket/v3.1/GRCh38/SNV_INDEL/runs/manual__2025-05-07T17-20-59.702114+00-00/new_entries.parquet/*.parquet')",
            )

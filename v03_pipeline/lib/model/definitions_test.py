...
class TestReferenceGenomeProperties(unittest.TestCase):
    ...
    def test_standard_contigs(self):
        expected_37_contigs = {
            '3', '12', '21', '2', '1', '7', '13', '8', '11', '22', 'MT', '14', 'Y', '18', '19',
            '20', '17', 'X', '10', '15', '16', '4', '5', '9', '6'
        }
        self.assertEqual(ReferenceGenome.GRCh37.standard_contigs, expected_37_contigs)

        expected_38_contigs = {
            'chr10', 'chr11', 'chr17', 'chr18', 'chr9', 'chr22', 'chr3', 'chrY', 'chr7', 'chr6',
            'chr13', 'chr19', 'chr16', 'chrX', 'chr12', 'chr2', 'chr21', 'chr20', 'chr8', 'chrM', 'chr5', 'chr4',
            'chr14', 'chr1', 'chr15'
        }
    ...
    def test_contig_recoding(self):
        expected_37_recode = {
            ...
            'chr15': '15', 'chr16': '16', 'chr17': '17', 'chr18': '18', 'chr19': '19', 'chr20': '20', 'chr21': '21',
            'chr22': '22', 'chrX': 'X', 'chrY': 'Y', 'MT': 'chrM'
        }
        self.assertDictEqual(ReferenceGenome.GRCh37.contig_recoding(include_mt=True), expected_37_recode)
        ...
        self.assertDictEqual(ReferenceGenome.GRCh38.contig_recoding(), expected_38_recode)

...
INCLUDE_PIPELINE_VERSION_IN_PREFIX = os.environ('INCLUDE_PIPELINE_VERSION_IN_PREFIX') == '1'
...
class Env:
    ...
    INCLUDE_PIPELINE_VERSION_IN_PREFIX: str = INCLUDE_PIPELINE_VERSION_IN_PREFIX

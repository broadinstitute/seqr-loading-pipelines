...
CLICKHOUSE_GCS_HMAC_KEY = os.environ.get('CLICKHOUSE_GCS_HMAC_KEY', '')
CLICKHOUSE_GCS_HMAC_SECRET = os.environ.get('CLICKHOUSE_GCS_HMAC_SECRET', '')
...
class Env:
    ...
    CLICKHOUSE_GCS_HMAC_KEY: str = CLICKHOUSE_GCS_HMAC_KEY
    CLICKHOUSE_GCS_HMAC_SECRET: str = CLICKHOUSE_GCS_HMAC_SECRET

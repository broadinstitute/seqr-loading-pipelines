...
POSTGRES_SERVICE_HOSTNAME = os.environ.get(
    'POSTGRES_SERVICE_HOSTNAME',
    'seqr-postgresql',
)
POSTGRES_SERVICE_PORT = int(os.environ.get('POSTGRES_SERVICE_PORT', '5432'))
...
class Env:
    ...
    POSTGRES_SERVICE_HOSTNAME: str = POSTGRES_SERVICE_HOSTNAME
    POSTGRES_SERVICE_PORT: int = POSTGRES_SERVICE_PORT
